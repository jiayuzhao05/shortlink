technical stack:SpringBoot + SpringCloudAlibaba + RocketMQ + ShardingSphere + Redis + MySQL + Sentinel

为了减少系统部署成本，直接使用了 Redis 代替消息队列
